...
class VeiculoForm(forms.ModelForm):
    ...
    marca = forms.ChoiceField(choices=MARCAS_CHOICES, label="Marca", widget=forms.Select(attrs={'class': 'form-control'}))
    veiculo = forms.CharField(max_length=50, label="Modelo", widget=forms.TextInput(attrs={'placeholder': 'Ex: Onix, Corolla, Renegade', 'class': 'form-control'}))
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['marca'].choices = self.MARCAS_CHOICES
